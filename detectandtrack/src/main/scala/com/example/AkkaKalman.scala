...
final case class LocalState(measurement: ArrayRealVector, invCovarianceMatrix: Array2DRowRealMatrix, sender: ActorRef[GlobalState]) extends EstimatorReceivable
