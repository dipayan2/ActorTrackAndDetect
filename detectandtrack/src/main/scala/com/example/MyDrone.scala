...
// object DroneNode {
//     trait GraphCreate
//     case class AddNeighbour (neighbour: ActorRef[GraphCreate]) extends GraphCreate
//     case class ReplyNeighbour(neighbour: ActorRef[GraphCreate]) extends GraphCreate
//     trait Event
